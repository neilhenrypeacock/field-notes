"""
Scraper: Agronomist & Arable Farmer
Source: aafarmer.co.uk (HTML scrape — feed returns 500)
...
SOURCE = "Agronomist & Arable Farmer"
NEWS_URL = "https://www.aafarmer.co.uk/news/"
HEADERS = {
    "User-Agent": (
        ...
        for card in cards[:15]:
            try:
                ...
                if link_tag and link_tag.get("href"):
                    url = link_tag["href"]
                    if url.startswith("/"):
                        url = "https://www.aafarmer.co.uk" + url
                if not title:
                    continue
                para = card.find("p")
