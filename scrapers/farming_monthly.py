"""
Scraper: Farming Monthly National
Source: farmingmonthly.co.uk (HTML scrape — RSS returns 403)
...
NEWS_URL = "https://www.farmingmonthly.co.uk/news/"
HEADERS = {
    "User-Agent": (
        ...
        for card in cards[:20]:
            try:
                ...
                if link_tag and link_tag.get("href"):
                    url = link_tag["href"]
                    if url.startswith("/"):
                        url = "https://www.farmingmonthly.co.uk" + url
                if not title:
                    continue
                para = card.find("p")
