...
def run(script: str, description: str, extra_args: list = None):
    ...
    result = subprocess.run(args, cwd="/Users/neilpeacock/Projects/fieldnotes")
...
def main():
    ...
    print(f"  50 6 * * * cd /Users/neilpeacock/Projects/fieldnotes && .venv/bin/python social/schedule_posts.py >> social/data/cron.log 2>&1")
    print("="*60 + "\n")
