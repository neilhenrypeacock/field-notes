...
sys.path.insert(0, str(Path("/Users/neilpeacock/farm/field-notes")))
...
SCRAPER_MAP = {
    ...
    "weather":            ("scrapers.met_office",       "scrape"),
...
def get_newsletter_headlines() -> list[str]:
    ...
    """
    newsletter_dir = Path("/Users/neilpeacock/farm/field-notes/newsletter/output")
